...
class TestKauppa(unittest.TestCase):
    ...
    def test_oikeat_parametrit(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_uudet_viitenumerot(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
